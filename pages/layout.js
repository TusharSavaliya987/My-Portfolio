    ...
    >
      <div className="lg:hidden">
        <div className=" bg-DeepNightBlack text-LightGray w-full h-10 flex items-center justify-between px-2 lg:hidden relative">
          ...
          >
            <span className="icon border-2 text-Primary border-Primary p-1 text-sm rounded-lg">
              <SlOptionsVertical />
            </span>
      ...
      <div className="flex relative h-full justify-between gap-x-3">
        ...
        >
          <div
            onClick={(e) => setIsOpen(!isOpen)}
            className="bg-MidNightBlack text-Primary hidden lg:flex items-center h-16 justify-center text-2xl "
          >
            <span className="icon border-2 border-Primary p-2 rounded-xl">
              {" "}
              <FaBars />
            </span>
          </div>
