        ...
        {credentialURL && (
          <div className="mt-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-center gap-2 bg-MidNightBlack hover:bg-opacity-80 text-xs text-emerald-400 rounded-full py-2 px-4 transition-all duration-500 hover:-translate-y-0.5"
            >
